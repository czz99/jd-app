<template>
  <div>
    <el-container>
      ...
      <el-container>
        <el-main :class="{'main-class1' : !meta.headerHide, 'main-class2' : meta.footerShow, 'main-class3': !meta.headerHide && meta.footerShow}">
      ...
      <el-footer v-show="meta.footerShow">
        ...
        <div @click="$router.push({path: '/driver-info'})" v-show="userType === '1'">
          ...
          <img v-show="currentPath === '/driver-info'" src="../assets/司机2.png" alt="">
        ...
        <!-- 普通用户 -->
        <div @click="$router.push({path: '/comm-home'})" v-show="userType === '2'">
        ...
        <div @click="$router.push({path: '/comm-classify'})" v-show="userType === '2'">
        ...
        <div @click="$router.push({path: '/shop-car'})" v-show="userType === '2'">
